...
//   RC rc = session->get_current_db()->create_view(view_name, create_view_stmt->con_infos(), create_view_stmt->attr_infos());
  RC rc = session->get_current_db()->create_view(view_name, create_view_stmt->con_infos(), 
        create_view_stmt->child_con_infos(), create_view_stmt->child_attr_infos(), create_view_stmt->attr_infos());
  return rc;
}